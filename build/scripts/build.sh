...
ld -o $wd/kernel.bin -z max-page-size=0x1000 -T ../lds/x64/kernel-ld-script.ld $wd/boot.32.cpp.o $wd/vm.o $wd/boot.64.cpp.o $wd/gdt.o $wd/page_mgr.o $wd/bitmap.o $wd/kmem_mgr.o
